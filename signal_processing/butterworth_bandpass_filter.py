...
#                                                                        #
# Descripción:                                                           #
# Código para ejecutar un 'Butterworth Bandpass Filter'                  #
#                                                                        #
# Fuente:                                                                #
...
# Se define H y los valores en H son inicializados en 0
H = np.zeros((M, N))
center_1 = M / 2
center_2 = N / 2

# Radio máximo y mínimo de corte
d_0 = 30.0
d_1 = 75.0
# El orden del Filtro
t_1 = 1
...
for i in range(1, M):
    for j in range(1, N):
        ...
        r = math.sqrt(r_1)
        # Usando los radios máximos y mínimos de corte para crear o anular la banda
        if r > d_0 and r < d_1:
            H[i, j] = 1 / (1 + (r / d_0) ** t_2)
